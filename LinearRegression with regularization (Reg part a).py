...
#give weights for attributes for last fold
weights = pd.DataFrame(np.asmatrix(w_rlr[1:,-1]),columns=attributeNames)

# Plot true vs estimated data for last fold
f = figure()
plot(y_test,m.predict(X_test),'.')
